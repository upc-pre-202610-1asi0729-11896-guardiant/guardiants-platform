...
import com.guardiants.platform.query.domain.repositories.VehicleSearchIndexRepository;
...
@Repository
public class VehicleSearchIndexRepositoryImpl implements VehicleSearchIndexRepository {

    private final SearchIndexPersistenceRepository persistenceRepository;
    private final SearchIndexEntityAssembler assembler;

    public VehicleSearchIndexRepositoryImpl(SearchIndexPersistenceRepository persistenceRepository,
    ...
    @Override
    public List<SearchResultView> search(String queryText, String vehicleStatus) {
        return persistenceRepository
                .findByEntityTypeAndLabelContainingIgnoreCase(SearchEntityType.VEHICLE.name(), queryText)
    ...
    public void upsert(SearchResultView view) {
        ...
        entity.setEntityType(SearchEntityType.VEHICLE.name());
